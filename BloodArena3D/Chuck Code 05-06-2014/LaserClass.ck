public class Laser{
    SndBuf laser => Gain master1 => ADSR env => Chorus chorus1 => JCRev reverb => Gain master => Gain level => dac;
    SndBuf click => Gain master2 => Chorus chorus4 => env => reverb => master => level;
    SndBuf explosion1 => Gain master3 => Chorus chorus2 => env => reverb => master => level;
    TriOsc explosion2 => Chorus chorus3 => env => reverb => master => level;
